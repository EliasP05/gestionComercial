<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="usu_apellido" name="usu_apellido" type="text" class="mt-1 block w-full" :value="old('usu_apellido', $user->usu_apellido)" required autofocus autocomplete="usu_apellido" />
            <x-input-error class="mt-2" :messages="$errors->get('usu_apellido')" />
        </div>
        <div>
