                            ...
                            <tr class="">
                                ...
                                <td>
                                    <input type="number" name="cantidad" value="{{ $producto['cantidad'] }}"
                                        class="w-10 px-0 rounded-md text-center border-slate-400 cantidad-input">
                                ...
                                <td><a href="{{ route('carrito.quitarItem', ['item' => $producto['codigo']]) }}"
                                        class="bg-red-600 p-1 rounded-md text-white hover:bg-slate-700">Eliminar</a>
                                </td>
                            </tr>
                            @php
